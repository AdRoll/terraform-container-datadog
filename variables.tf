...
variable "container_port" {
  type        = number
  description = "Useful if docker labels are undefined"
  default     = 8080
}
...
variable "ecs_fargate" {
  type        = bool
  description = "Set to true to add ECS_FARGATE"
  default     = true
}

variable "apm_enabled" {
  type        = bool
  description = "Set to true to add DD_APM_ENABLED"
  default     = true
}

variable "apm_non_local_traffic" {
  type        = bool
  description = "Set to true to add DD_APM_NON_LOCAL_TRAFFIC"
  default     = true
}

variable "process_agent_enabled" {
  type        = bool
  description = "Set to true to add DD_PROCESS_AGENT_ENABLED"
  default     = true
}
